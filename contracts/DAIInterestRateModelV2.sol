...
/**
  * @title Welnance's DAIInterestRateModel Contract (version 2)
  * @author Welnance (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original Welnance Protocol whitepaper.
